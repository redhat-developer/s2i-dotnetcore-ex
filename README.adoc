...
builder, `dotnet/dotnet-21-rhel7`, execute the following command:

[source]
----
s2i build --ref=dotnetcore-2.2 --context-dir=app https://github.com/redhat-developer/s2i-dotnetcore-ex dotnet/dotnet-22-rhel7 aspnet-app
----
